...
public class emailservice {
    ...
    //three params
    emailservice(String toEmail,String title,String subject) {
        this.jsonObject= "{"+quote+"toEmail"+quote+":"+quote+toEmail+quote+","
    ...
    //four params
    emailservice(String toEmail,String title,String subject,String body) {
        this.jsonObject= "{"+quote+"toEmail"+quote+":"+quote+toEmail+quote+","
